...
import { generateListeningMultipleChoiceSingleQuestion } from '../services/geminiService.js';
...
const ListeningMultipleChoiceSinglePractice = ({ navigateTo }) => {
    ...
    const fetchNewQuestion = useCallback(async () => {
        ...
        try {
            const data = await generateListeningMultipleChoiceSingleQuestion();
    ...
    const renderResult = () => {
        ...
        return React.createElement('div', { className: "mt-8 bg-white p-6 rounded-xl shadow-lg text-center animate-fade-in" },
            ...
            React.createElement('p', { className: `mt-2 text-xl ${isCorrect ? 'text-green-600' : 'text-red-600'}` }, 
                isCorrect ? "You selected the correct answer." : "You did not select the correct answer."
            ),
             React.createElement('div', { className: "mt-4 text-left bg-gray-50 p-4 rounded-lg" },
                React.createElement('h3', { className: "font-semibold mb-2 text-gray-800" }, "Correct Answer:"),
    ...
    return React.createElement('div', { className: "max-w-4xl mx-auto" },
        ...
        React.createElement('h1', { className: "text-3xl font-bold text-gray-900" }, 'Multiple Choice, Single Answer'),
        React.createElement('p', { className: "text-gray-600 my-2" }, 'Listen to the recording and answer the multiple-choice question.'),
...
export default ListeningMultipleChoiceSinglePractice;