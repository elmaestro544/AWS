...
import { generateReadingMultipleChoiceSingleQuestion } from '../services/geminiService.js';
import { BackIcon, RefreshIcon } from './icons.js';

const ReadingMultipleChoiceSinglePractice = ({ navigateTo }) => {
    ...
    const fetchNewQuestion = useCallback(async () => {
        ...
        try {
            const data = await generateReadingMultipleChoiceSingleQuestion();
    ...
    return React.createElement('div', { className: "max-w-4xl mx-auto" },
        ...
        React.createElement('p', { className: "text-gray-600 my-2" }, 'Read the text and answer the question by selecting the single correct response.'),
...
export default ReadingMultipleChoiceSinglePractice;