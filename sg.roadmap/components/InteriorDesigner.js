...
const InteriorDesigner = ({ language, currentUser }) => {
  ...
  const renderHistoryItem = (item) => (
    React.createElement('div', {
        ...
        className: "p-2 bg-slate-200/50 dark:bg-card-gradient border border-slate-300/50 dark:border-white/10 rounded-lg cursor-pointer hover:bg-brand-blue/10 dark:hover:bg-brand-blue/30"
      },
          ...
          React.createElement('div', { className: "grid grid-cols-1 md:grid-cols-3 gap-8" },
            React.createElement('div', { className: "space-y-3" },
                ...
                React.createElement('div', {
                    ...
                    onDrop: handleDrop,
                    className: `aspect-square rounded-xl flex flex-col items-center justify-center border-2 border-dashed transition-colors cursor-pointer ${isDragOver ? 'border-brand-blue bg-slate-200 dark:bg-card-gradient' : 'bg-slate-200/50 dark:bg-card-gradient border-slate-300 dark:border-white/20 hover:border-slate-400 dark:hover:border-white/40'}`
                },
            ...
            React.createElement('div', { className: "mt-12" },
              React.createElement('div', { className: "grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch" },
                React.createElement('div', { className: "text-center" },
                  ...
                  imagePreview && React.createElement('img', { src: imagePreview, alt: "Original room", className: "rounded-lg w-full" })
                ),
                React.createElement('div', { className: "text-center flex flex-col" },
                  ...
                  generatedOutput.type === 'image' ? (
                      React.createElement('div', { className: "relative" },
                          React.createElement('img', { src: generatedOutput.content, alt: "Redesigned room", className: "rounded-lg w-full" }),
                          React.createElement('button', {
                      ...
                      React.createElement('div', { className: "relative flex-grow h-full" },
                          React.createElement('div', { className: "h-full min-h-[400px] max-h-[512px] overflow-y-auto p-4 bg-light-input-gradient dark:bg-input-gradient rounded-lg text-left whitespace-pre-wrap" },
