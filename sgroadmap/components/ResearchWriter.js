    ...
    React.createElement('div', { className: "grid grid-cols-1 md:grid-cols-2 gap-6" },
      ...
      React.createElement('div', { className: "flex flex-col gap-4" },
        React.createElement('textarea', {
          ...
          className: "w-full h-80 p-3 bg-slate-100 dark:bg-input-gradient border border-slate-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-brand-blue focus:outline-none resize-none"
        }),
        React.createElement('button', {
      ...
      // Output Panel
      React.createElement('div', { className: "relative w-full h-96 p-3 bg-white dark:bg-card-gradient border border-slate-200 dark:border-white/10 rounded-xl overflow-y-auto" },
