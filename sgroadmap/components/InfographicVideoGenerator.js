...
const InfographicVideoGenerator = ({ language, theme }) => {
    ...
    const renderInputScreen = () => (
        React.createElement('div', { className: 'w-full max-w-4xl mx-auto' },
            ...
            React.createElement('div', { className: 'bg-white dark:bg-card-gradient border border-slate-200 dark:border-white/10 rounded-2xl p-6 shadow-xl' },
                React.createElement('div', { className: 'space-y-4' },
                    React.createElement('textarea', {
                        value: textInput,
                        onChange: e => setTextInput(e.target.value),
                        placeholder: t.videoGenInputPlaceholder,
                        className: 'w-full h-32 p-3 bg-slate-100 dark:bg-input-gradient border border-slate-200 dark:border-white/10 rounded-lg focus:ring-2 focus:ring-brand-blue focus:outline-none resize-none'
                    }),
                    React.createElement('div', null,
                        React.createElement('button', { onClick: () => fileInputRef.current?.click(), className: 'flex items-center gap-2 text-sm text-slate-500 dark:text-brand-text-light hover:text-slate-800 dark:hover:text-white' },
                        ...
                        React.createElement('div', { className: 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4' },
                            ['duration', 'voice', 'orientation', 'style', 'language'].map(opt => 
                                React.createElement('select', { 
                                    ...
                                    className: 'w-full p-2 bg-slate-100 dark:bg-input-gradient border border-slate-200 dark:border-white/10 rounded-lg focus:ring-2 focus:ring-brand-blue focus:outline-none'
                                },
                    ...
                    React.createElement('button', {
                        ...
                        className: 'w-full font-bold text-lg py-3 px-4 rounded-full transition-all bg-brand-red text-white hover:bg-red-500 shadow-lg shadow-brand-red/30'
